...
@nut_function
def ReadImage(sample, columns, pathfunc=None, as_gray=False, dtype='uint8'):
    """
    ...
    :param bool as_gray: If true, load as grayscale image.
    ...
    def load(fileid):
        ...
        if isinstance(pathfunc, str):
            ...
            filepath = fileid
        return load_image(filepath, as_gray=as_gray, dtype=dtype)
